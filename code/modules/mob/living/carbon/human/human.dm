...
/mob/living/carbon/human/New()
	...
	groin.owner = src
	var/datum/organ/external/groin/butt/butt = new /datum/organ/external/groin/butt( src )
	butt.owner = src
...
/mob/living/carbon/human/blob_act()
	...
	var/list/zones = list("head","chest","chest", "groin", "butt", "l_arm", "r_arm", "l_hand", "r_hand", "l_leg", "r_leg", "l_foot", "r_foot")
...
/mob/living/carbon/human/meteorhit(O as obj)
	...
	if (health > 0)
		var/dam_zone = pick("chest", "chest", "chest", "head", "groin", "butt")
	...
	if (M.a_intent == "hurt")
		...
		if (health > 0)
			...
			/*else if (istype(wear_suit, /obj/item/clothing/suit/swat_suit))
				...
				var/damage = rand(1, 3)
				var/dam_zone = pick("chest", "l_hand", "r_hand", "l_leg", "r_leg", "groin", "butt")
