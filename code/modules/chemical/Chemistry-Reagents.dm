...
datum
	reagent
		...
		var/old_color = "#000000" // rgb: 0, 0, 0 (does not support alpha channels - yet!)
...
*/
		vaccine
			...
			id = "vaccine"
			reagent_state = LIQUID
			old_color = "#C81040" // rgb: 200, 16, 64
		...
		water
			...
			reagent_state = LIQUID
			old_color = "#0064C8" // rgb: 0, 100, 200
		...
		lube
			...
			reagent_state = LIQUID
			old_color = "#009CA8" // rgb: 0, 156, 168
		...
		anti_toxin
			...
			reagent_state = LIQUID
			old_color = "#C8A5DC" // rgb: 200, 165, 220
		...
		stoxin
			...
			reagent_state = LIQUID
			old_color = "#E895CC" // rgb: 232, 149, 204
		...
		space_drugs
			...
			reagent_state = LIQUID
			old_color = "#60A584" // rgb: 96, 165, 132
		...
		silicate
			...
			reagent_state = LIQUID
			old_color = "#C7FFFF" // rgb: 199, 255, 255
		...
		oxygen
			...
			reagent_state = GAS
			old_color = "#808080" // rgb: 128, 128, 128

		copper
			name = "Copper"
			id = "copper"
			description = "A highly ductile metal."
			old_color = "#6E3B08" // rgb: 110, 59, 8
		...
		potassium
			...
			reagent_state = SOLID
			old_color = "#A0A0A0" // rgb: 160, 160, 160
		...
		sulfur
			...
			description = "A chemical element."
			reagent_state = SOLID
			old_color = "#BF8C00" // rgb: 191, 140, 0
		...
		carbon
			...
			description = "A chemical element."
			reagent_state = SOLID
			old_color = "#C77400" // rgb: 199, 116, 0
		...
		phosphorus
			...
			description = "A chemical element."
			reagent_state = SOLID
			old_color = "#832828" // rgb: 131, 40, 40
		...
		pacid
			...
			reagent_state = LIQUID
			old_color = "#8E18A9" // rgb: 142, 24, 169
		...
		thermite
			...
			reagent_state = SOLID
			old_color = "#673910" // rgb: 103, 57, 16
		...
		mutagen
			...
			reagent_state = LIQUID
			old_color = "#13BC5E" // rgb: 19, 188, 94
		...
		virus_food
			...
			old_color = "#899613" // rgb: 137, 150, 19
...
*/
		...
		gold
			...
			reagent_state = SOLID
			old_color = "#F7C430" // rgb: 247, 196, 48
		...
		silver
			...
			reagent_state = SOLID
			old_color = "#D0D0D0" // rgb: 208, 208, 208
		...
		uranium
			...
			reagent_state = SOLID
			old_color = "#B8B8C0" // rgb: 184, 184, 192
		...
		aluminum
			...
			reagent_state = SOLID
			old_color = "#A8A8A8" // rgb: 168, 168, 168
		...
		space_cleaner
			...
			reagent_state = LIQUID
			old_color = "#A5F0EE" // rgb: 165, 240, 238
...
//				M:sdisabilities &= ~1		Replaced by eye surgery
		...
		zombiepowder
			...
			old_color = "#669900" // rgb: 102, 153, 0
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		nanites
			...
			reagent_state = LIQUID
			old_color = "#535E66" // rgb: 83, 94, 102
...
//foam precursor
		...
		fluorosurfactant
			...
			reagent_state = LIQUID
			old_color = "#9E6B38" // rgb: 158, 107, 56
...
// this is lithium hydride. Add other recipies (e.g. LiH + H2O -> LiOH + H2) eventually
		...
		foaming_agent
			...
			reagent_state = SOLID
			old_color = "#664B63" // rgb: 102, 75, 99
...
// 	condiments, additives, and such go.
		nutriment
			...
			old_color = "#664330" // rgb: 102, 67, 48
...
*/
		...
		frostoil
			...
			reagent_state = LIQUID
			old_color = "#B31008" // rgb: 139, 166, 233
		...
		psilocybin
			...
			old_color = "#E700E7" // rgb: 231, 0, 231
		...
		syndicream
			...
			nutriment_factor = 1 * REAGENTS_METABOLISM
			old_color = "#AB7878" // rgb: 171, 120, 120
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		orangejuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			old_color = "#E78108" // rgb: 231, 129, 8
		...
		berryjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			old_color = "#863333" // rgb: 134, 51, 51
		...
		poisonberryjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			old_color = "#863353" // rgb: 134, 51, 83
		...
		lemonjuice
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			old_color = "#863333" // rgb: 175, 175, 0
		...
		milk
			...
			reagent_state = LIQUID
			old_color = "#DFDFDF" // rgb: 223, 223, 223
		...
		soymilk
			...
			reagent_state = LIQUID
			old_color = "#DFDFC7" // rgb: 223, 223, 199
		...
		cream
			...
			reagent_state = LIQUID
			nutriment_factor = 1 * REAGENTS_METABOLISM
			old_color = "#DFD7AF" // rgb: 223, 215, 175
		...
		holywater
			...
			reagent_state = LIQUID
			old_color = "#E0E8EF" // rgb: 224, 232, 239
		...
		tequilla
			...
			reagent_state = LIQUID
			old_color = "#A8B0B7" // rgb: 168, 176, 183
		...
		wine
			...
			reagent_state = LIQUID
			old_color = "#7E4043" // rgb: 126, 64, 67
		...
		sodawater
			...
			reagent_state = LIQUID
			old_color = "#619494" // rgb: 97, 148, 148
...
/////////////////////////////////////////////////////////////////cocktail entities//////////////////////////////////////////////
		...
		bilk
			...
			reagent_state = LIQUID
			old_color = "#895C4C" // rgb: 137, 92, 76
		...
		threemileisland
			...
			reagent_state = LIQUID
			old_color = "#666340" // rgb: 102, 99, 64
		...
		white_russian
			...
			reagent_state = LIQUID
			old_color = "#A68340" // rgb: 166, 131, 64
		...
		screwdrivercocktail
			...
			reagent_state = LIQUID
			old_color = "#A68310" // rgb: 166, 131, 16
		...
		singulo
			...
			reagent_state = LIQUID
			old_color = "#2E6671" // rgb: 46, 102, 113
