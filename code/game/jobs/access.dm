...
/proc/get_access(job)
	switch(job)
		...
		if("Detective")
			return list(access_security, access_forensics_lockers, access_morgue, access_maint_tunnels, access_court, access_detective)
		if("Medical Doctor")
		...
		if("Scientist")
			return list(access_tox, access_tox_storage, access_research, access_manufacturing, access_xenobiology)
		if("Head of Security")
...
/proc/get_all_accesses()
	return list(access_security, access_brig, access_armory, access_forensics_lockers, access_court, access_detective,
...
/proc/get_region_accesses(var/code)
	switch(code)
		if(0)
			return get_all_accesses()
		if(1) //security
			return list(access_security, access_brig, access_armory, access_forensics_lockers, access_court, access_hos, access_detective)
		if(2) //medbay
...
/proc/get_all_jobs()
	return list("Assistant", "Station Engineer", "Shaft Miner", "Detective", "Medical Doctor", "Captain", "Security Officer", "Warden",
				...
				"Chief Engineer", "Research Director", "Botanist", "Librarian", "Lawyer", "Virologist", "Cargo Technician", "Chief Medical Officer", "Cyborg", "AI")
